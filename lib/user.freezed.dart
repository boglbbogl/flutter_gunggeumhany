...
class _$UserTearOff {
  ...
  _User call({required String userKey}) {
    return _User(
      userKey: userKey,
    );
  }
...
class _$_User implements _User {
  const _$_User({required this.userKey});
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(userKey));
...
abstract class _User implements User {
  const factory _User({required String userKey}) = _$_User;
